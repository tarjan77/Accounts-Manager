...
import { CheckIcon, FileIcon, MapPinIcon, PhoneIcon } from "@/components/icons";
import {
  deleteJob,
  markJobCompleted,
  markPaymentReceived
  ...
  return (
    <article className="grid gap-4 p-4 sm:p-5 lg:grid-cols-[120px_1fr_auto] lg:items-start">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-sm font-medium text-muted">{getJobTitle(job)}</p>
      ...
      <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap lg:justify-end">
        {phone ? (
          <a
            ...
            className="btn-secondary min-h-10 gap-2 px-3"
            href={`tel:${phone}`}
          >
...
export function CalendarView({
  ...
  return (
    <section className="card overflow-hidden">
      ...
      <div className="grid gap-4 p-3 lg:grid-cols-[minmax(0,0.82fr)_minmax(420px,0.46fr)] lg:p-4">
